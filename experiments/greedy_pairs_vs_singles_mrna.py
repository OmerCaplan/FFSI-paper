...
TCGA-BRCA mRNA Gene Expression Data (Cancer vs Normal)
...
def run_experiment(data_path, n_trials=100, n_sample_features=5000, k=8,
    ...
    if output_dir:
        ...
        results_path = Path(output_dir) / f"greedy_pairs_vs_singles_mrna_{timestamp}.csv"
...
DATA_PATH = Path("/Users/macbook/Documents/FFSI-paper/data/tcga_brca_mrna_binary.csv")
